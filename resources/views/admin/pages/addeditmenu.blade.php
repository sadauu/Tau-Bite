	...
	@endif
   	...
   	<div class="panel panel-default">
            <div class="panel-body">
                ...
                <form action="{{ url('admin/restaurants/view/'.$restaurant_id.'/menu/addmenu') }}" method="POST" class="form-horizontal padding-15" id="menu_form" name="menu_form" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
