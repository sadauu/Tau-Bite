...
<span aria-hidden="true">&times;</span></button>
    ...
    <div class="panel panel-default">
            <div class="panel-body">
                <form action="{{ url('admin/restaurants/addrestaurant') }}" method="POST" class="form-horizontal padding-15" name="category_form" id="category_form" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                <input type="hidden" name="id" value="{{ isset($restaurant->id) ? $restaurant->id : null }}">
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Cafeteria/Spots Type</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Cafeteria Name</label>
                      <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Cafeteria Slug</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label for="avatar" class="col-sm-3 control-label">Cafeteria Logo</label>
                    <div class="col-sm-9">
                        <div class="media">
